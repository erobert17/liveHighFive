            ...
            <div class="col-sm-10 col-sm-offset-2 col-md-8 col-md-offset-3 col-lg-6 col-lg-offset-3">
                ...
                <div class="panel panel-primary <?php if (Auth::check() && Auth::user()->hasRole('admin', true)): ?> panel-info  <?php endif; ?>">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row vert-offset-bottom-1">
                            <div class="col-md-12">
                                <label>Digital Download File's URL<br>
                                    <?php if($landingPage[0]->digitalDownloadUrl != null ): ?>
                                        <input name="digitalDownloadUrl" id="digitalDownloadUrl" class="longInput" value="<?php echo e($landingPage[0]->digitalDownloadUrl); ?>" placeholder="dropbox.com/yourfile">
                                    <?php else: ?>
                                        <input name="digitalDownloadUrl" id="digitalDownloadUrl" class="longInput" placeholder="dropbox.com/yourfile">
                                    <?php endif; ?>
                        ...
                        <div class="row vert-offset-bottom-1">
                            <div class="col-md-12">
                                <label>Upload Digital Download File:</label>
                            </div>
                            
                            <div class="col-md-12">
                                <form action="/uploadDigitalDownload" method="POST" class="dropzone needsclick dz-clickable" id="avatarDropzone" style="min-height:181px;">
                                                                    
                                <input type="hidden" name="userID" value="{{ $user->id }}" >
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                
                                    <?php 
                                        $ch = curl_init('http://growyourleads.com/uploads/users/id/' .Auth::user()->id. '/TEST.png');    
                                        ...
                                        if($code == 200){
                                           ...
                                           echo '<img id="newBackground" class="user-avatar" style="border-radius: none;" src="http://growyourleads.com/uploads/users/id/' .Auth::user()->id. '/TEST.png" />';   
                                        }else{
                        ...
                        <div class="row vert-offset-bottom-1">
                            ...
                            <div class="col-md-12">
                                <form action="/uploadProductImg7" method="POST" class="dropzone needsclick dz-clickable" id="avatarDropzone" style="min-height:181px;">
                                                                    
                                <input type="hidden" name="userID" value="<?php echo e($user->id); ?>" >
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                
                                    <?php 
                                        $ch = curl_init('http://growyourleads.com/uploads/users/id/' .Auth::user()->id. '/uploadDigitalDownloadProductImg.png');    
                                        ...
                                        if($code == 200){
                                           $backgroundExists = true;
                                           echo '<img id="newBackground" class="user-avatar" style="border-radius: none;" src="http://growyourleads.com/uploads/users/id/' .Auth::user()->id. '/uploadDigitalDownloadProductImg.png" />';   
                                        }else{
                                            $backgroundExists = false;
                                        }
                         ...
                         <div class="row vert-offset-bottom-1">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php elseif($landingPageNumber == 7): ?>
                                    <form action="/uploadBackground7" method="POST" class="dropzone needsclick dz-clickable" id="avatarDropzone">
                                <?php endif; ?>
                                    <input type="hidden" name="userID" value="<?php echo e($user->id); ?>" >
                                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                    <?php 
                                                                ...
                                                                <?php if($backgroundExists == true): ?>
                                                                    ...
                                                                    <?php elseif($landingPageNumber == 4): ?>
                                                                        ...
                                                                        <img id="newBackground" class="user-avatar" style="border-radius: none;" src="<?php echo e(asset('uploads/users/id/' .Auth::user()->id. '/backgroundLP4.jpg')); ?>" />

                                                                    <?php elseif($landingPageNumber == 5): ?>
                                                                    
                                                                        <img id="newBackground" class="user-avatar" style="border-radius: none;" src="<?php echo e(asset('uploads/users/id/' .Auth::user()->id. '/backgroundLP5.jpg')); ?>" />

                                                                    <?php elseif($landingPageNumber == 7): ?>
                                                                    
                                                                        <img id="newBackground" class="user-avatar" style="border-radius: none;" src="<?php echo e(asset('uploads/users/id/' .Auth::user()->id. '/backgroundLP7.jpg')); ?>" />
                                                                ...
                                                                <?php elseif($landingPageNumber == 4): ?>
                                                                    ...
                                                                    <img id="newBackground" class="user-avatar" style=" border-radius: none;" src="<?php echo e(asset('uploads/placeholderBG4.jpg')); ?>" />
                                                                <?php elseif($landingPageNumber == 5 || $landingPageNumber == 7): ?>
