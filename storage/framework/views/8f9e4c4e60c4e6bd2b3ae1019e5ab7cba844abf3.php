                ...
                <div class="panel panel-primary <?php if (Auth::check() && Auth::user()->hasRole('admin', true)): ?> panel-info  <?php endif; ?>">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row vert-offset-bottom-1">
                            ...
                            <div class="col-md-12">
                                <form action="/uploadProductImg9" method="POST" class="dropzone needsclick dz-clickable" id="avatarDropzone" style="min-height:181px;">
                                                                    
                                <input type="hidden" name="userID" value="<?php echo e($user->id); ?>" >
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                
                                    <?php 
                                        $ch = curl_init('http://growyourleads.com/uploads/users/id/' .Auth::user()->id. '/uploadMailingListProductImg.png');    
                                        ...
                                        if($code == 200){
                                           ...
                                           echo '<img id="newBackground" class="user-avatar" style="border-radius: none;" src="http://growyourleads.com/uploads/users/id/' .Auth::user()->id. '/uploadMailingListProductImg.png" />';   
                                        }else{
                         ...
                         <div class="row vert-offset-bottom-1">
                            ...
                            <div class="col-md-12">
                                <form action="/uploadBackground9" method="POST" class="dropzone needsclick dz-clickable" id="avatarDropzone">
                                    <input type="hidden" name="userID" value="<?php echo e($user->id); ?>" >
                                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                    <?php 
                                                                ...
                                                                <?php if($backgroundExists == true): ?>
                                                                    <img id="newBackground" class="user-avatar" style=" border-radius: none;" src="<?php echo e(asset('uploads/users/id/' .Auth::user()->id. '/backgroundLP'.$landingPageNumber.'.jpg')); ?>" />
