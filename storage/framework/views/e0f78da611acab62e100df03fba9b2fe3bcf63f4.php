                        ...
                        <div class="row vert-offset-bottom-1">
                            ...
                            <div class="col-md-4">
                                <label>Title Text Color<br>
                                    ...
                                    {value:'<?php echo e($landingPage[0]->titleColor); ?>'}" value="jscolor {value:'<?php echo e(htmlentities($landingPage[0]->titleColor)); ?>'}" style="width: 5em;">
                        ...
                        <div class="row vert-offset-bottom-1">
                            <div class="col-md-12">
                                <label>Coupon Code<br>
                                    <input type="text" name="coupon" value="<?php echo e($landingPage[0]->coupon); ?>" id="coupon"/>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="row vert-offset-bottom-1">
                            <div class="col-md-12">
                                <label>Your Online Storefront URL<br>
                                    <input type="text" name="storeUrl" value="<?php echo e($landingPage[0]->storeUrl); ?>" id="storeUrl"/>
                                </label>
                            </div>
                        </div>
