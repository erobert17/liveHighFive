                        ...
                        <div class="row vert-offset-bottom-1">
                            <div class="col-md-12">
                                <label>Digital Download File's URL<br>
                                    @if($landingPage[0]->digitalDownloadUrl != null )
                                        <input name="digitalDownloadUrl" id="digitalDownloadUrl" class="longInput" value="{{$landingPage[0]->digitalDownloadUrl}}" placeholder="dropbox.com/yourfile">
                                    @else
                                    ...
                                    <?php 
                                                                ...
                                                                @if($backgroundExists == true)
                                                                    ...
                                                                    @elseif($landingPageNumber == 7)
                                                                        ...
                                                                        <img id="newBackground" class="user-avatar" style="border-radius: none;" src="{{asset('uploads/users/id/' .Auth::user()->id. '/backgroundLP7.jpg')}}" />
                                                                ...
                                                                @elseif($landingPageNumber == 5 || $landingPageNumber == 7)
