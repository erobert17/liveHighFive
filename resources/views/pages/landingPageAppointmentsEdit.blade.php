                        ...
                        <div class="row vert-offset-bottom-1">
                            ...
                            <div class="col-md-4">
                                <label>Title Text Color<br>
                                    ...
                                    {value:'{{ htmlentities($landingPage[0]->titleColor) }}'}" value="jscolor {value:'{{ $landingPage[0]->titleColor }}'}" style="width: 5em;">
                        ...
                        <div class="row vert-offset-bottom-1">
                            ...
                            <div class="col-md-4">
                                <label>Disclaimer Text Color<br>
                                    ...
                                    {value:'{{ htmlentities($landingPage[0]->disclaimerColor) }}'}" value="jscolor {value:'{{ $landingPage[0]->disclaimerColor }}'}" style="width: 5em;">
                                        <input id="disclaimerColor" name="disclaimerColor" class="selectedColor saveColorVal saveColorChange" type="hidden" value="{{ htmlentities($landingPage[0]->disclaimerColor) }}" />
                                    @else
                                        <input id="disclaimerSelect" name="disclaimerSelect" class="jscolor 
                                    {required:false}" value="" style="width: 5em;">
                                ...
                                <form action="/uploadBackground8" method="POST" class="dropzone needsclick dz-clickable" id="avatarDropzone">
                                    ...
                                    <?php 
                                                                ...
                                                                @if($backgroundExists == true)
                                                                    ...
                                                                    <img id="newBackground" class="user-avatar" style=" border-radius: none;" src="http://growyourleads.com/uploads/users/id/{{Auth::user()->id}}/backgroundLP8.jpg" />
